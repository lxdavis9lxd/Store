...
exports.find = async (offset, pageSize) => {
    const query = `SELECT  cs.customerName as customerNumber_Value, t.* FROM payments t  join customers cs on t.customerNumber = cs.customerNumber  LIMIT ?, ?`;
    return getRows(query,[offset,pageSize]);
}

exports.findOne = async (customerNumber,checkNumber) => {
    const query = `SELECT  cs.customerName as customerNumber_Value, t.* FROM payments t  join customers cs on t.customerNumber = cs.customerNumber  WHERE t.customerNumber=? AND t.checkNumber=? LIMIT 0,1`;
...
exports.count = async () => {
    const query = `SELECT count(*) TotalCount FROM payments t  join customers cs on t.customerNumber = cs.customerNumber  `;
...
exports.getByCustomernumber = async (offset, pageSize, customerNumber) => {
    const query = `SELECT  cs.customerName as customerNumber_Value, t.* FROM payments t  join customers cs on t.customerNumber = cs.customerNumber  WHERE t.customerNumber= ? LIMIT ?, ?`;
    return getRows(query,[customerNumber,offset,pageSize]);
}

exports.getByCustomernumberCount = async (customerNumber) => {
    const query = `SELECT count(*) TotalCount FROM payments t  join customers cs on t.customerNumber = cs.customerNumber  WHERE t.customerNumber= ?`;
